  ...
  return (
    <Layout>
      ...
      {showPopup && (
        <div className="popup-overlay">
          <div className="popup-content">
            ...
            <iframe
              src="https://www.blackbox.ai/agent/RAJARATHANAMIjUXsf3"
              width="100%"
              height="600px"
              frameBorder="0"
              allowFullScreen
      ...
      <a
        ...
        rel="noreferrer"
      >
        Click to Connect with Owner{" "}
      </a>
      <p>For support around our products and prior provided services:</p>
      <i className="fa-regular fa-envelope"></i>&nbsp;
      <a
        className="regular-link"
        href="mailto:veerendravamsi66@gmail.com"
        target="_blank"
        rel="noreferrer"
      >
        Click to Connect with Owner{" "}
      ...
      <p>
        Know somebody that may need our help? Share the RajaRathanam website
        with others:
      </p>
